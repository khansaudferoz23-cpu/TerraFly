...
| Backend scientific/safety suite | PASS | 26 tests in 1.38 s on the final full run |
...
| Declared artifacts downloaded/hashed | 13/13 PASS |
| Recovered scale | 39.999999983 m per relative unit |
| Recovered offset | 99.9999999999 m |
| Held-out RMSE | 0.000003494 m |
...
- All 26 backend tests passed from the extracted source using the prepared test environment.
...
This report proves software behavior, release integrity, and the synthetic calibration oracle. It does not prove real-world height accuracy. No compatible independently surveyed remote-sensing height dataset was supplied.
