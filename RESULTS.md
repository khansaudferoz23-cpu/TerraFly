...
|---|---|---:|---:|---|---|
| Backend fast suite | `.venv\\Scripts\\python.exe -m pytest -q` | PASS | 1.66 s pytest | `handoff/DAY_1_TEST_REPORT.md` | Python 3.12.13 |
| Frontend component | `npm test` | PASS | 19.59 s | `handoff/DAY_1_TEST_REPORT.md` | Node 22.23.1 |
| Frontend production build | `npm run build` | PASS | 0.178 s Vite | `handoff/DAY_1_TEST_REPORT.md` | Vite 8.2.2 |
