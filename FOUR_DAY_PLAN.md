...
## Day 1 — stable relative path

Bootstrap, safeguards, environment evidence, API/UI contract, safe image inspection, real and deterministic adapters, numeric/preview artifacts, job provenance, fast tests, production frontend build, real model smoke, and private milestone handoff.

## Day 2 — 3D and robust inference

Complete navigation modes, point inspection, orientation fixtures, mesh/GLB export, tiled inference, memory safeguards, browser smoke tests, and user-friendly restart/cleanup.
